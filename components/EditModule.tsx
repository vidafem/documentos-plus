          ...
          <div className="flex flex-wrap gap-4 items-end">
            <div className="flex-1 min-w-[220px] bg-white/5 p-4 rounded-2xl border border-white/5 space-y-2">
              ...
              <div className="grid grid-cols-5 gap-2">
                <input required type="text" maxLength={2} value={editForm.diaApertura} onChange={(e) => updateEditForm({ diaApertura: e.target.value })} className="col-span-1 bg-white/10 border border-white/10 rounded-lg p-2 text-xs text-center text-white outline-none focus:border-indigo-500" placeholder="DD" />
                <select value={editForm.mesApertura} onChange={(e) => updateEditForm({ mesApertura: e.target.value })} className="col-span-2 bg-neutral-900 border border-white/10 rounded-lg p-2 text-[10px] text-white outline-none">
                ...
                <input type="text" maxLength={4} value={editForm.anioApertura} onChange={(e) => updateEditForm({ anioApertura: normalizeYearInput(e.target.value), oficioAnio: normalizeYearInput(e.target.value) })} className="col-span-2 bg-white/5 border border-white/10 rounded-lg p-2 text-xs text-center text-white outline-none focus:border-indigo-500" />
              </div>
            </div>
            ...
            <div className="flex-1 min-w-[220px] bg-white/5 p-4 rounded-2xl border border-white/5 space-y-2">
              ...
              <div className="grid grid-cols-5 gap-2">
                <input required type="text" maxLength={2} value={editForm.diaCierre} onChange={(e) => updateEditForm({ diaCierre: e.target.value })} className="col-span-1 bg-white/10 border border-white/10 rounded-lg p-2 text-xs text-center text-white outline-none focus:border-indigo-500" placeholder="DD" />
                <select value={editForm.mesCierre} onChange={(e) => updateEditForm({ mesCierre: e.target.value })} className="col-span-2 bg-neutral-900 border border-white/10 rounded-lg p-2 text-[10px] text-white outline-none">
                  <option value="01">Ene</option><option value="02">Feb</option><option value="03">Mar</option><option value="04">Abr</option><option value="05">May</option><option value="06">Jun</option><option value="07">Jul</option><option value="08">Ago</option><option value="09">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dic</option>
                </select>
                <input type="text" maxLength={4} value={editForm.anioCierre} onChange={(e) => updateEditForm({ anioCierre: normalizeYearInput(e.target.value) })} className="col-span-2 bg-white/5 border border-white/10 rounded-lg p-2 text-xs text-center text-white outline-none focus:border-indigo-500" />
              </div>
            </div>
          </div>
